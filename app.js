...
const main = async function() {
   ...
   */
  const runJava = async function(messageId, main, files, timeLimitCompileMs, timeLimitExecutionMs) {
   ...
   * @param timeLimitExecutionMs {Number}: Execution timeout.
   */
  const runJunit = async function(messageId, tests, files, timeLimitCompileMs, timeLimitExecutionMs) {
